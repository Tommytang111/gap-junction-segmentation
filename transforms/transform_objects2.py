...
if __name__ == "__main__":
    ...
    preds = np.load("/home/tommy111/projects/def-mzhen/tommy111/outputs/volumetric_results/unet_p03lmvzp/sem_adult_s000-699/volume_block_downsampled8x.npy").astype(bool)
    preds_upsampled = upsample(preds, (1,2,2), save_path="/home/tommy111/projects/def-mzhen/tommy111/outputs/volumetric_results/unet_p03lmvzp/sem_adult_s000-699/volume_block_downsampled4x.npy")
    nr_preds = preds_upsampled & nr_volume
    np.save("/home/tommy111/projects/def-mzhen/tommy111/outputs/volumetric_results/unet_p03lmvzp/sem_adult_s000-699/volume_constrained_in_NR_block_downsampled4x.npy", nr_preds.astype(np.uint8))
    ...
    calculate_entity_metrics(preds="/home/tommy111/projects/def-mzhen/tommy111/outputs/volumetric_results/unet_p03lmvzp/sem_adult_s000-699/volume_block_downsampled4x.npy",
