...
def main():
    ...
    pipeline = GapJunctionSegmenter(
        ...
        #Path to model
        model_path="/home/tommy111/projects/def-mzhen/tommy111/models/best_models/unet_3D2D_204vols_sem_dauer_1_r1x0hn96.pt",
        ...
        pred_dir= Path(tmpdir) / "outputs/inference_results/unet_r1x0hn96/sem_dauer_1_s000-850",
        #Path to where to save assembled results
        assembled_dir="/home/tommy111/projects/def-mzhen/tommy111/outputs/assembled_results/unet_r1x0hn96/sem_dauer_1_s000-850",
