...
A complete implementation of the UNet architecture for image segmentation.
"""
...
if __name__ == "__main__":
    ...
    model = UNet(n_channels=1, n_classes=2, bilinear=True)  # 1 input channel (grayscale), 2 classes (background, gap junction)
